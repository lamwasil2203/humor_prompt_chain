...
export default async function NewStepPage({ params }: Props) {
  ...
  const [flavorRes, stepTypesRes, modelsRes, inputTypesRes, outputTypesRes] = await Promise.all([
  ...
  return (
    <div className="max-w-2xl">
      <div className="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 mb-6">
        ...
        <span>/</span>
        <span className="text-gray-900 dark:text-white font-medium">Add step</span>
      </div>

      <h1 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Add step</h1>
